...
![Span Aggregation Overview](../images/span-aggregation-overview.png#only-light)
![Span Aggregation Overview](../images/span-aggregation-overview-dark.png#only-dark)
