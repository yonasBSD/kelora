...
text.normalized([patterns])          Replace patterns with placeholders (<ipv4>, <email>, <credit_card>, etc.)
                                     ...
                                     duration, num, credit_card (Luhn-validated), ssn (SSA-validated), phone (NANP-validated)
...
drain_templates()                    Return array of templates with same fields (except is_new)
                                     ...
                                     PII filters (opt-in): credit_card (Luhn-validated), ssn (SSA-validated), phone (NANP-validated)
