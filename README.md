...
> [!NOTE]
> Kelora works well for the author and ships with 770+ automated tests plus cargo-audit/deny. It is also an experiment in agentic AI development: both code and tests are AI-generated (Claude Code, Codex CLI) by a Rust beginner, without manual code review. Use appropriate judgment for your environment and expect breaking changes before 1.0. See [SECURITY.md](SECURITY.md) for details.
...
Kelora is intentionally built as an experiment in agentic AI-assisted development. Both implementation and tests are generated by Claude Code and GPT-5 Codex, guided by a Rust beginner focused on behaviour rather than manual code review. The project leans on its 770+ automated tests, cargo-audit, and cargo-deny for validation, so please review the code yourself before relying on it in production environments.
